    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.Clear();
                Marco();
                Console.SetCursorPosition(40, 11); Console.Write("1- Quienes somos ? ");
                Console.SetCursorPosition(40, 12); Console.Write("2- Menu Aplicacion ");
                Console.SetCursorPosition(40, 13); Console.Write("0- Salir ");
                Console.SetCursorPosition(40, 14); Console.Write("Digite una opcion. ");
